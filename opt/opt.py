...
class NetOption (object):
    ...
    def __init__(self):
        ...
        self.experimentID = "test_#casia1#_squeeze_resnet3d_s16m2g2a0.5#mining_margin#_margin2_featuredim=21_focal_cumulative_reduce=1_124"  ##"resnet3d_multiway_CONTRA_MARGIN=2_RATIO=0.1_pretrain_0917"
