...
class NetOption (object):
    ...
    def __init__(self):
        #  ------------ General options ---------------------------------------
        self.save_head_path = "/home/datasets/CASIA2/model/darklight/"  # where to save model and log code etc
        ...
        self.label_path = "/home/yangyifan/code/multiViewCNN/Multi_ViewCNN/dataProcess/split_bjdata/BJ_dl_label.csv" # BJ label 0826
        ...
        self.rootpath = "/home/datasets/CASIA2/splited_bj_resize/BJ_Resizev1/"#"/home/datasets/CASIA2/splited_Casia2/"
        ...
        self.experimentID = "resnet3d_contra_multiscale_margin=0.2_ratio=0.1_pretrain_0922"  ##"resnet3d_multiway_CONTRA_MARGIN=2_RATIO=0.1_pretrain_0917"
