...
from dataloader.my_loader_oneclock_newquarter import *  ###cut in half
# from dataloader.random_step import *
...
class DataLoader (object):
    ...
    def asoct_data(self, data_path, label_path, rootpath):
        ...
        # train_dir = data_path + "/wide_split/train_all.txt"  #half clock 0219
        # test_dir = data_path + "/wide_split/val_all.txt"  #half clock 0219
        ...
        if opt.contra_learning == True:
            # train_dir = data_path + "/oneclock_data_split/contrastive_learning/train_representation.txt"
            # test_dir = data_path + "/oneclock_data_split/trainv5test.txt"
            train_dir = data_path + "/oneclock_data_split/trainv5.txt"
            test_dir = data_path + "/oneclock_data_split/valv5.txt"
        else:
            # train_dir = data_path + "/oneclock_data_split/combine_train_val/train_val.txt"
            # test_dir = data_path + "/oneclock_data_split/valv5.txt"
            # train_dir = data_path + "/oneclock_data_split/trainv5.txt"
            ###oversample method
            train_dir = "/home/yangyifan/code/multiViewCNN/Multi_ViewCNN/dataProcess/oneclock_data_split/oversampling/overtrain_shuffle.txt"##fix version 0430
            test_dir = data_path + "/oneclock_data_split/valv5.txt"##0413##fix version 0430

            ###oversample step=3
            # train_dir = "/home/yangyifan/code/multiViewCNN/Multi_ViewCNN/dataProcess/oneclock_data_split/one_add_left_positive/sliding_leftpositive_step3_trainv6_lc.txt"
            # train_dir = "/home/yangyifan/code/multiViewCNN/Multi_ViewCNN/dataProcess/oneclock_data_split/one_add_left_positive/leftpositive_step3_trainv7_lc.txt"
            # test_dir = "/home/yangyifan/code/multiViewCNN/Multi_ViewCNN/dataProcess/oneclock_data_split/one_add_left_positive/valv6_lc.txt"
            ###
            # train_dir = data_path + "/External_set/overlapmethod/RU9798_bidirection_badcase.txt"
            # test_dir = data_path + "/External_set/overlapmethod/RU9798_bidirection_badcase.txt"##|noAloneNtgPoagTest.txt|ntgpoagTest.txt|noaloneTest.txt|CASIARU_test.txt|overlapForTest.txt|overlapmethod/overlapstep5.txt|overlapmethod/RU9798.txt
            # train_dir = data_path + "/oneclock_data_split/trainv5test.txt"
            # test_dir = data_path + "/oneclock_data_split/trainv5test.txt"
            ###half clock for RU
            # train_dir = data_path + "/External_set/RU_Halftest.txt"
            # test_dir = data_path + "/External_set/RU_Halftest.txt"#
            ###half clock FOR INTERNAL
            # train_dir = data_path + "/wide_split/0416_half_split/train_half.txt"  # half clock 0416
            # test_dir = data_path + "/wide_split/0416_half_split/val_half.txt"  # half clock 0416
